...
const String VESC_CAN_CMD_STR[NUM_VESC_CAN_CMD] = {
	"SET_DUTY",
	"SET_CURRENT",
	"SET_CURRENT_BRAKE",
	"SET_RPM",
	...
	"FILL_RX_BUFFER_LONG",
	"PROCESS_RX_BUFFER",
	"PROCESS_SHORT_BUFFER",
	"STATUS",
	"SET_CURRENT_REL",
	"SET_CURRENT_BRAKE_REL",
	"SET_CURRENT_HANDBRAKE",
	"SET_CURRENT_HANDBRAKE_REL",
	"STATUS_2",
	"STATUS_3",
	"STATUS_4",
	"PING",
	...
	"DETECT_APPLY_ALL_FOC_RES",
	"CONF_CURRENT_LIMITS",
	"CONF_STORE_CURRENT_LIMITS",
	"CONF_CURRENT_LIMITS_IN",
	"CONF_STORE_CURRENT_LIMITS_IN",
	"CONF_FOC_ERPMS",
	"CONF_STORE_FOC_ERPMS",
	"STATUS_5",
	"POLL_TS5700N8501_STATUS",
	"CONF_BATTERY_CUT",
	"CONF_STORE_BATTERY_CUT",
	"SHUTDOWN",
	"IO_BOARD_ADC_1_TO_4",
	"IO_BOARD_ADC_5_TO_8",
	"IO_BOARD_ADC_9_TO_12",
	"IO_BOARD_DIGITAL_IN",
	"IO_BOARD_SET_OUTPUT_DIGITAL",
	"IO_BOARD_SET_OUTPUT_PWM",
	"BMS_V_TOT",
	"BMS_I",
	"BMS_AH_WH",
	"BMS_V_CELL",
...
const String VESC_FAULT_CODE_STR[NUM_VESC_FAULT_CODE] = {
	"FAULT_NONE",
	"FAULT_OVER_VOLTAGE",
	"FAULT_UNDER_VOLTAGE",
	"FAULT_DRV",
